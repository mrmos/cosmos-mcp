...
URL: https://api.cosmos.so/graphql?q=GetClusterElements

## Query
```graphql
query GetClusterElements($clusterId: ClusterId, $pageCursor: String, $userId: UserId, $pageSize: Int, $isLoggedIn: Boolean!, $showCollaborator: Boolean!) {
  clusterConnections(
    clusterId: $clusterId
